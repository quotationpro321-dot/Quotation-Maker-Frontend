...
type THolidaySkyguruPageHeaderProps = {
  /** Horizontal page margin; vertical rhythm is identical on every page. */
  marginPx: number;
};

/**
 * SkyGuru logo + "Holiday Quotation" label + "Book with confidence" badge,
 * shared by every content page.
 */
export function HolidaySkyguruPageHeader({
  marginPx,
}: THolidaySkyguruPageHeaderProps) {
  return (
    <header
